...
public class DeclinedAdjustmentsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_decline, container, false);

        Helper helper = Helper.getInstance(v.getContext());

        recyclerView = v.findViewById(R.id.recyclerViewAdjustmentDecline);
    ...
    private void whenError () {
        ...
        arguments.putInt("RETURN_TO", Flag.DECLINED_ADJUJSTMENTS_FRAGMENT);
    ...
    public void loadMyDeclineRequest() {
