...
import com.example.timekeeping_beta.Fragments.DEPRECATED.DEPRECATED_UserEmployee.RequestLeave.LeaveAdapter.LeaveApproveAdapter;
...
public class ApprovedLeaveFragment extends Fragment implements LeaveApproveAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = v.findViewById(R.id.recyclerViewLeaveApprove);
    ...
    private void setuprecyclerView(List<LeaveRequestItem> leaveRequestList) {
        if (leaveRequestList.size() > 0) {
            LeaveApproveAdapter leaveAdapter = new LeaveApproveAdapter(leaveRequestList, this);
    ...
    private void whenError () {
        ...
        arguments.putInt("RETURN_TO", Flag.APPROVED_LEAVE_FRAGMENT);
