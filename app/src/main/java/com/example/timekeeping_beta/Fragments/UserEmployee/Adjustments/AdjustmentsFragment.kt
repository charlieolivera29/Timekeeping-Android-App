package com.example.timekeeping_beta.Fragments.UserEmployee.Adjustments
...
class AdjustmentsFragment : Fragment(), PendingAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AdjustmentViewModel = ViewModelProviders.of(activity!!).get(com.example.timekeeping_beta.Fragments.UserEmployee.Adjustments.AdjustmentViewModel::class.java)
