package com.example.timekeeping_beta.Fragments.UserEmployee.Leaves
...
import com.example.timekeeping_beta.Fragments.DEPRECATED.DEPRECATED_UserEmployee.RequestLeave.LeaveFragments.RequestLeaveFragment
...
class LeavesFragment : Fragment(), LeaveAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LeaveViewModel = ViewModelProviders.of(this).get(com.example.timekeeping_beta.Fragments.UserEmployee.Leaves.LeaveViewModel::class.java)
    }
