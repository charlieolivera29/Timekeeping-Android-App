...
public class HolidayTypesAdapter extends RecyclerView.Adapter<HolidayTypesAdapter.MyViewHolder> {

    private List<HolidayType> mDataset;
    private List<HolidayType> tempList;
    ...
    public HolidayTypesAdapter(List<HolidayType> myDataset, RecyclerViewClickListener onItemClickListener) {
    ...
    @Override
    public void onBindViewHolder(final HolidayTypesAdapter.MyViewHolder holder, final int position) {

        final HolidayType holiday_type = mDataset.get(position);

        holder.rvi_holiday_type_id.setText(holiday_type.getHoliday_type_code());
        holder.rvi_holiday_type_name.setText(holiday_type.getHoliday_type_name());
