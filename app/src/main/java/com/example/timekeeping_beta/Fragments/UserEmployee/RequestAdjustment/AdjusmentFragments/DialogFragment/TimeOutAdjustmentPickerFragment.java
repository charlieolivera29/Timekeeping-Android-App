...
public class TimeOutAdjustmentPickerFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker timePicker, int hourOfDay, int minute) {
        ...
        TextView txtTimeOut = getActivity().findViewById(R.id.txt_adjusted_time_out);
        ...
        txtTimeOut.setText(converted_time);
    }
}
