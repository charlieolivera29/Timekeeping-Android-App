...
import com.example.timekeeping_beta.Fragments.DEPRECATED.DEPRECATED_UserEmployee.RequestOvertime.Adapter.RequestedOvertimesAdapter
import com.example.timekeeping_beta.Fragments.DEPRECATED.DEPRECATED_UserEmployee.RequestOvertime.RequestOvertimeFragment
...
class OvertimeFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        OvertimeViewModel = ViewModelProviders.of(this).get(com.example.timekeeping_beta.Fragments.UserEmployee.Overtimes.OvertimeViewModel::class.java)
    }
