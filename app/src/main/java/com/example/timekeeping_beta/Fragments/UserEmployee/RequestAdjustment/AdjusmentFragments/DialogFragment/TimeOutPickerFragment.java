...
public class TimeOutPickerFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker timePicker, int hourOfDay, int minute) {
        ...
        TextView txtTimeOut = getActivity().findViewById(R.id.txt_time_out);
