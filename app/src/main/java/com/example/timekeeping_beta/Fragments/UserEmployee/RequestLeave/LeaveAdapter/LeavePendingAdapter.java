package com.example.timekeeping_beta.Fragments.UserEmployee.RequestLeave.LeaveAdapter;
...
public class LeavePendingAdapter extends RecyclerView.Adapter<LeavePendingAdapter.LeaveRequestViewHolder> {

    private Context ctx;
    private OnItemClickListener onItemClickListener;
    private List<LeaveRequestItem> leaveRequestItemList;

    public LeavePendingAdapter(List<LeaveRequestItem> leaveRequestItemList, OnItemClickListener onItemClickListener) {
    ...
    public void onBindViewHolder(@NonNull LeaveRequestViewHolder leaveRequestViewHolder, int i) {
        ...
        leaveRequestViewHolder.rvi_status.setBackgroundColor(ContextCompat.getColor(ctx, R.color.colorPending));
    }
